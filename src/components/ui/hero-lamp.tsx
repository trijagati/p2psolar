  ...
  return (
    ...
    <LampContainer>
      <motion.h1
        ...
        >
        Distribute Energy   <br /> 
          the 
        <span className=" text-yellow-200 tracking-normal">
           {" "}RIGHT{" "}
          </span> 
           way
      </motion.h1>
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative pt-60 flex min-h-screen flex-col items-center justify-center overflow-hidden bg-slate-950 w-full rounded-md z-0",
        className
      )}
    >
